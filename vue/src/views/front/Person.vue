<template>
  <div class="main-content">
    ...
    <el-dialog :width="dialogWidth"  title="修改密码" :visible.sync="dialogVisible"
...
export default {
  ...
  computed: {
    dialogWidth() {
      ...
      if (screenWidth <= 450) {
        return '85%'; // 屏幕宽度小于等于450px时，对话框宽度为85%
      } else if (screenWidth <= 700) {
        return '70%'; // 屏幕宽度小于等于700px时，对话框宽度为70%
      } else if (screenWidth <= 1250) {
        return '50%'; // 屏幕宽度小于等于1250px时，对话框宽度为50%
      } else {
        return '30%'; // 屏幕宽度大于1250px时，对话框宽度为30%
      }
    },
  },
  mounted() {
