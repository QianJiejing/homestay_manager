<template>
  <div class="main-content">
    <div style="width: 65%; margin: 50px auto; text-align: left">
      <div style="margin-top: 30px">
        <el-row :gutter="20">
          <el-col :span="6" style="margin-top: 10px" v-for="item in homestayData" :key="item.id">
            <img :src="item.avatar" style="width: 100%; height: 175px; border-radius: 10px" alt="" @click="navToDetail(item.id)">
            <div style="font-size: 16px; font-weight: bold; margin-top: 10px; color: #1a6840FF"><i style="margin-right: 2px" class="fas fa-home-user"></i>{{item.name}}</div>
