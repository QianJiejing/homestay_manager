<template>
  <div>
    ...
    <div class="operation">
      <el-button v-if="user.role === 'HOMESTAY'" type="primary" plain @click="handleAdd">新增</el-button>
    ...
    <div class="table">
      <el-table :data="tableData" stripe  @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="name" label="客房编号" show-overflow-tooltip></el-table-column>
        <el-table-column prop="status" label="房间状态" show-overflow-tooltip></el-table-column>
    ...
    <el-dialog title="信息" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form label-width="100px" style="padding-right: 50px" :model="form" :rules="rules" ref="formRef">
        <el-form-item prop="name" label="客房编号">
          <el-input placeholder="请输入编号" v-model="form.name" autocomplete="off" ></el-input>
        </el-form-item>
