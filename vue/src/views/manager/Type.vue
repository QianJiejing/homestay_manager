<template>
  <div>
    ...
    <div class="operation">
      <el-button type="primary" plain @click="handleAdd" v-if="user.role === 'HOMESTAY'">新增</el-button>
    ...
    <el-dialog title="房间分类" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
      <el-form :model="form" label-width="100px" style="padding-right: 50px" :rules="rules" ref="formRef">
        <el-form-item label="房间图片" prop="img"><!--:show-file-list="false"-->
          <el-upload
