<template>
  <div>
    ...
    <!-- 房型评论对话框 -->
    <el-dialog title="新增房型评论" :visible.sync="showRoomCommentDialog" width="40%" :close-on-click-modal="false" destroy-on-close>
      <!-- 房型评论表单内容 -->
      <el-form label-width="100px" style="padding-right: 50px" v-model="commentForm">
        <el-form-item prop="commentContent" label="房型评价">
          <div style="display: flex;align-items: center;">
            ...
            <el-col :span="22">
              <el-input type="textarea" style="overflow-y: auto;" ref="commentInput" v-model="commentForm.content" autosize></el-input>
            </el-col>
          </div>
        </el-form-item>
...
export default {
  ...
  methods: {
    clickEmoji(emoji) {
      ...
      } else if (this.showRoomCommentDialog) {
        // 否则插入到评论输入框中
