    ...
    <div class="main-body-content">
      <div style="display: flex; align-items: flex-start">
        <div style="width: 200px; border: 1px solid #ddd; border-radius: 5px; height: calc(50vh + 125px);">
          ...
          <div class="user-list-box" style="height: 15%">
          ...
          <div style="padding: 10px; border-bottom: 1px solid #ddd; color: #000; background-color: #eee">民宿房主</div>
          <div class="user-list-box" style="height: 31%">
          ...
          <div style="padding: 10px; border-bottom: 1px solid #ddd; color: #000; background-color: #eee">民宿用户</div>
          <div class="user-list-box" style="height: 28%; overflow-y: scroll">
